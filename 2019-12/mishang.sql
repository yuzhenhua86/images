/*
 ...
 Source Server         : root@test-server
 Source Server Type    : MySQL
 Source Server Version : 50722
 Source Host           : test-server:3306
 Source Schema         : mishang

 Target Server Type    : MySQL
 Target Server Version : 50722
 File Encoding         : 65001

 Date: 25/04/2019 20:35:20
*/
...
CREATE TABLE `address` (
  ...
  `default` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '默认地址',
...
-- ----------------------------
-- Table structure for admin_auth_assignment
-- ----------------------------
...
-- ----------------------------
-- Records of admin_auth_assignment
-- ----------------------------
BEGIN;
INSERT INTO `admin_auth_assignment` VALUES ('SuperAdmin', '2', 1521009456);
COMMIT;

-- ----------------------------
-- Table structure for admin_auth_item
-- ----------------------------
...
-- ----------------------------
-- Records of admin_auth_item
-- ----------------------------
BEGIN;
INSERT INTO `admin_auth_item` VALUES ('banner', 2, 'banner', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('brand', 2, 'brand', NULL, NULL, 1522119000, 1522119000);
INSERT INTO `admin_auth_item` VALUES ('buyNotice', 2, 'buyNotice', NULL, NULL, 1522501996, 1522501996);
INSERT INTO `admin_auth_item` VALUES ('category', 2, 'category', NULL, NULL, 1520996988, 1520996988);
INSERT INTO `admin_auth_item` VALUES ('comment', 2, 'comment', NULL, NULL, 1521473573, 1521473573);
INSERT INTO `admin_auth_item` VALUES ('coupon', 2, 'coupon', NULL, NULL, 1522077459, 1522077459);
INSERT INTO `admin_auth_item` VALUES ('credit', 2, 'credit', NULL, NULL, 1522053435, 1522053435);
INSERT INTO `admin_auth_item` VALUES ('emailLog', 2, 'emailLog', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('exchange', 2, 'exchange', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('express', 2, 'express', NULL, NULL, 1517965801, 1517965801);
INSERT INTO `admin_auth_item` VALUES ('feedback', 2, 'feedback', NULL, NULL, 1521473573, 1521473573);
INSERT INTO `admin_auth_item` VALUES ('goods', 2, 'goods', NULL, NULL, 1522053435, 1522053435);
INSERT INTO `admin_auth_item` VALUES ('goodsService', 2, 'goodsService', NULL, NULL, 1522122712, 1522122740);
INSERT INTO `admin_auth_item` VALUES ('level', 2, 'level', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('log', 2, 'log', NULL, NULL, 1521018022, 1521018022);
INSERT INTO `admin_auth_item` VALUES ('message', 2, 'message', NULL, NULL, 1522053435, 1522053435);
INSERT INTO `admin_auth_item` VALUES ('messageCategory', 2, 'messageCategory', NULL, NULL, 1522053435, 1522053435);
INSERT INTO `admin_auth_item` VALUES ('order', 2, 'order', NULL, NULL, 1522077459, 1522077459);
INSERT INTO `admin_auth_item` VALUES ('payment', 2, 'payment', NULL, NULL, 1522501996, 1522501996);
INSERT INTO `admin_auth_item` VALUES ('project', 2, 'project', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('rbac', 2, 'rbac', NULL, NULL, 1517965801, 1517965801);
INSERT INTO `admin_auth_item` VALUES ('serviceLabel', 2, 'serviceLabel', NULL, NULL, 1522501996, 1522501996);
INSERT INTO `admin_auth_item` VALUES ('setting', 2, 'setting', NULL, NULL, 1520947620, 1520947620);
INSERT INTO `admin_auth_item` VALUES ('sms', 2, 'sms', NULL, NULL, 1522501996, 1522501996);
INSERT INTO `admin_auth_item` VALUES ('smsSetting', 2, 'smsSetting', NULL, NULL, 1521473573, 1521473573);
INSERT INTO `admin_auth_item` VALUES ('SuperAdmin', 1, '超级管理员', NULL, NULL, 1521009399, 1521009399);
INSERT INTO `admin_auth_item` VALUES ('user', 2, 'user', NULL, NULL, 1520947620, 1520947620);
COMMIT;

-- ----------------------------
-- Table structure for admin_auth_item_child
-- ----------------------------
...
-- ----------------------------
-- Records of admin_auth_item_child
-- ----------------------------
BEGIN;
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'brand');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'category');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'goods');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'level');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'order');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'payment');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'serviceLabel');
INSERT INTO `admin_auth_item_child` VALUES ('SuperAdmin', 'user');
COMMIT;
...
CREATE TABLE `admin_nav` (
  ...
  `tree` int(10) unsigned DEFAULT NULL,
  ...
  `created_at` int(10) DEFAULT NULL,
  PRIMARY KEY (`nav_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='后台导航';

-- ----------------------------
-- Records of admin_nav
-- ----------------------------
BEGIN;
INSERT INTO `admin_nav` VALUES (1, '所有导航', NULL, NULL, NULL, 0, 1, 1, 42, 0, 1, 1522077817);
INSERT INTO `admin_nav` VALUES (2, '商品', '/goods', 'am-goods', '', 0, 1, 2, 17, 1, 1, 1522077817);
INSERT INTO `admin_nav` VALUES (3, '出售中', '/goods', '', 'goods', 2, 1, 3, 4, 2, 1, 1522077953);
INSERT INTO `admin_nav` VALUES (4, '已售完', '/goods', '', 'goods', 2, 1, 5, 6, 2, 1, 1522077986);
INSERT INTO `admin_nav` VALUES (5, '仓库中', '/goods', '', 'goods', 2, 1, 7, 8, 2, 1, 1522078002);
INSERT INTO `admin_nav` VALUES (6, '回收站', '/goods', '', 'goods', 2, 1, 9, 10, 2, 1, 1522078156);
INSERT INTO `admin_nav` VALUES (7, '订单', '/order', 'am-order', '', 0, 1, 18, 31, 1, 1, 1522078258);
INSERT INTO `admin_nav` VALUES (8, '商品分类', '/goods/category', '', 'category', 2, 1, 11, 12, 2, 1, 1522078553);
INSERT INTO `admin_nav` VALUES (9, '待发货', '/order?status=wait_send', '', 'order', 7, 1, 19, 20, 2, 1, 1522078621);
INSERT INTO `admin_nav` VALUES (10, '待付款', '/order?status=wait_pay', '', 'order', 7, 1, 21, 22, 2, 1, 1522078658);
INSERT INTO `admin_nav` VALUES (11, '待收货', '/order?status=wait_receive', '', 'order', 7, 1, 23, 24, 2, 1, 1522078692);
INSERT INTO `admin_nav` VALUES (12, '已完成', '/order?status=success', '', 'order', 7, 1, 25, 26, 2, 1, 1522078723);
INSERT INTO `admin_nav` VALUES (13, '已关闭', '/order?status=close', '', 'order', 7, 1, 27, 28, 2, 1, 1522078767);
INSERT INTO `admin_nav` VALUES (14, '全部订单', '/order', '', 'order', 7, 1, 29, 30, 2, 1, 1522078814);
INSERT INTO `admin_nav` VALUES (15, '会员', '/user', 'am-user', '', 0, 1, 32, 37, 1, 1, 1522078836);
INSERT INTO `admin_nav` VALUES (16, '会员管理', '/user', '', 'user', 15, 1, 33, 34, 2, 1, 1522078896);
INSERT INTO `admin_nav` VALUES (17, '会员等级', '/user/level', '', 'level', 15, 1, 35, 36, 2, 1, 1522079084);
INSERT INTO `admin_nav` VALUES (18, '品牌管理', '/goods/brand', '', 'brand', 2, 1, 13, 14, 2, 1, 1522119019);
INSERT INTO `admin_nav` VALUES (19, '商品服务', '/serviceLabel', '', 'serviceLabel', 2, 1, 15, 16, 2, 1, 1522122761);
INSERT INTO `admin_nav` VALUES (20, '设置', '', 'am-setting', '', 0, 1, 38, 41, 1, 1, 1522501951);
INSERT INTO `admin_nav` VALUES (21, '支付设置', '/payment', '', 'payment', 20, 1, 39, 40, 2, 1, 1522502014);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_user` VALUES (2, 'admin', '$2y$13$wfflKQFENQRY.jOdVFkNpOhnO0mooQKQKGM9tWop7hjf3BzxGpGoG', '超级管理员', 'SuperAdmin', 1, '', 1491472036, 1533604885, 'sxoX_EqmoGQharlXYk-8oj6HAWGHzEAZ');
COMMIT;
...
CREATE TABLE `app` (
  ...
  `app_type` varchar(10) NOT NULL DEFAULT 'app',
  `platform` varchar(10) NOT NULL COMMENT '平台(ios、android)',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `created_at` int(10) DEFAULT NULL,
  PRIMARY KEY (`app_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='APP客户端表';
...
CREATE TABLE `area` (
  ...
  `depth` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '地区深度，从1开始',
  `region` varchar(3) DEFAULT NULL COMMENT '大区名称',
  PRIMARY KEY (`area_id`),
  KEY `area_parent_id` (`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5025 DEFAULT CHARSET=utf8 COMMENT='地区表';
...
INSERT INTO `area` VALUES (421, '思茅市', 25, 0, 2, NULL);
...
INSERT INTO `area` VALUES (1208, '北市区', 78, 0, 3, NULL);
INSERT INTO `area` VALUES (1209, '南市区', 78, 0, 3, NULL);
...
INSERT INTO `area` VALUES (1225, '清苑县', 78, 0, 3, NULL);
INSERT INTO `area` VALUES (1226, '满城县', 78, 0, 3, NULL);
...
INSERT INTO `area` VALUES (4209, '双流县', 385, 0, 3, NULL);
